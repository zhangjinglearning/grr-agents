...
describe("UsersService Integration Tests", () => {
  ...
  describe("createUser", () => {
    ...
    it("should throw ConflictException for duplicate email", async () => {
      ...
      await expect(service.createUser(registerInput)).rejects.toThrow(
        ConflictException,
      );
    });
    ...
    it("should handle case-insensitive email uniqueness", async () => {
      ...
      await expect(service.createUser(secondUser)).rejects.toThrow(
        ConflictException,
      );
    });
  ...
  describe("getUserCount", () => {
    ...
    it("should return correct count after creating users", async () => {
      ...
      for (const userData of users) {
        await service.createUser(
          UserTestFactory.createMockRegisterInput(userData),
        );
      }
  ...
  describe("Database Consistency and Transactions", () => {
    ...
    it("should handle database constraint violations properly", async () => {
      ...
      await expect(service.createUser(user1)).rejects.toThrow(
        ConflictException,
      );
  ...
  describe("Performance Tests", () => {
    ...
    it("should handle rapid sequential queries efficiently", async () => {
      ...
      const queryPromises = createdUsers.map((user) =>
